...
/*----- Subscription Form ----- */
   ...
   $(document).ready(function() {
    ...
    document.getElementById("poetry-form").addEventListener("submit", function(event) {
      event.preventDefault();
      alert("Thank you for submitting your work.!! You will be notified shortly by our team..");
    });
