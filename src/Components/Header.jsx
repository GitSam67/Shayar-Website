  ...
  return (
    <header id="navbar" className="bg-black shadow-md w-full fixed top-0 left-0">
      <nav className="container md:flex items-center justify-between py-4 md:px-10 px-7">
        ...
        <li className='md:ml-8 text-xl md:my-0 my-7'>
        <a href="../Shayar-Website/src/index.html" className="transition delay-40 font-black font-mono text-xl text-white border-b-2 border-transparent hover:text-pink-500 hover:border-pink-500  duration-200">
