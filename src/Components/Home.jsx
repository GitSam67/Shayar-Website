    ...
    <section id="home">
      <div className="container mx-auto mt-20 flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow w-full mb-16 md:mb-0 flex flex-col mx-auto items-center text-center">
          ...
          <h3 className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-700 via-purple-600 to-pink-600 title-font text-3xl md:text-4xl mb-4 font-black">
            <TypeAnimation
              sequence={[
                'Shayar App', 
                1000,
